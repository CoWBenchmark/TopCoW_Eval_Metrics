...
def test_graph_dict_from_files_yml():
    ...
    pred_edg_path = TESTDIR / "antpos_np_arr_pred.yml"
...
def test_graph_dict_from_files_json():
    ...
    cow-ant-post-classification_pred.JSON
    {
        "anterior": {"L-A1": 1, "Acom": 1, "3rd-A2": 1, "R-A1": 1},
        "posterior": {"L-Pcom": 0, "L-P1": 0, "R-P1": 0, "R-Pcom": 0},
    }
    """
    gt_edg_path = TESTDIR / "cow-ant-post-classification.json"
    pred_edg_path = TESTDIR / "cow-ant-post-classification_pred.JSON"
